...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for(int a0 = 0; a0 < t; a0++){
            int i = in.nextInt();
            int j = in.nextInt();
            int largestVehicleType = getLargestVehicleType(i, j, width);
            System.out.println(largestVehicleType);
        }
    }
    
    static int getLargestVehicleType(int enter, int exit, int[] width) {
        int min = width[enter];
        for (int i = enter + 1; i < exit + 1; i++) {
