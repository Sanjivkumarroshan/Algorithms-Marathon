...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for(int a0 = 0; a0 < t; a0++){
            ...
            int chocolates = getChocolates(n, c, m);
            System.out.println(chocolates);
        }
    }
    
    static int getChocolates(int money, int price, int wrapper) {
        int boughtChocolates = (money / price);
        int numberOfWrapper = boughtChocolates;
        do {
            int newChocolate = numberOfWrapper / wrapper;
            boughtChocolates += newChocolate;
            numberOfWrapper = numberOfWrapper - (newChocolate * wrapper) + newChocolate;
        } while (numberOfWrapper >= wrapper);
